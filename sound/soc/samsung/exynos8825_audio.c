...
static int uaif1_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	for_each_rtd_codec_dais(rtd, i, dai) {
		if (strstr(dai->component->name, "aw882xx_smartpa")) {
			drvdata = (struct aw882xx *)snd_soc_component_get_drvdata(dai->component);
			...
			register_aw882xx_bigdata_cb(dai->component);
